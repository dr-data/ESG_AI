...
def main(start_data, end_data):
    ...
    st.set_page_config(page_title="Green Chain", page_icon=icon_path,
                       layout='centered', initial_sidebar_state="collapsed")
    _, logo, _ = st.columns(3)
    logo.image(icon_path, width=200)
    style = ("text-align:center; padding: 0px; font-family: arial black;, "
             "font-size: 400%")
    title = f"<h1 style='{style}'>Green Chain, ESG Score powered by AI</h1><br><br>"
    ...
    if company and company != "Select a Company":
        ...
        link_df = df_company[["DATE", "URL"]].head(20).copy()
